 ...
 * 
 * 
 * public class DC_Migration { String Application =
 * "Domain Controller Migration Automation"; // For New Application Change here
 * required String ExcelImportFile = "DC - Migration Production.xlsx"; // For
 * New Application Change here required String Env ="Prod Environment"; // For
 * New Application Change here required String ProjectName
 * =("************************* "+Application+" ************************* ");
