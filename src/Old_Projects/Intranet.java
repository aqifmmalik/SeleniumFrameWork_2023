 ...
 * 
 * 
 * public class Intranet { String Application = "Intranet -  Automation"; // For
 * New Application Change here required String ExcelImportFile =
 * "Intranet.xlsx"; // For New Application Change here required String Env
 * ="Prod Environment"; // For New Application Change here required String
 * ProjectName
 * =("************************* "+Application+" ************************* ");
