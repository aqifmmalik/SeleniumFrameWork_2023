 ...
 * java.util.Arrays; import java.util.Date; import javax.swing.JLabel; import
 * javax.swing.JOptionPane; import javax.swing.JPanel; import
 * javax.swing.JPasswordField; import org.apache.log4j.Level; import
 * org.apache.log4j.Logger; import org.apache.log4j.PropertyConfigurator; import
 ...
 * 
 * 
 * public class CS { // Code Version 8/19/22
 * 
 * String Application = "CS -  Automation"; // For New Application Change here
 * required String ExcelImportFile = "CS.xlsx"; // For New Application Change
 ...
 * String ProjectName
 * =("************************* "+Application+" ************************* ");
 * WebDriver driver; ExtentReports report; ExtentTest logger; String FileName =
 * new SimpleDateFormat("MM-dd-YY ").format(new Date()); String DriverPathie32 =
 * "IO/Drivers/IEDriver32_old.exe"; String DriverPathie64 =
 * "IO/Drivers/IEDriver64.exe"; String DriverPathEdge =
 * "IO/Drivers/msedgedriver.exe"; String DriverPathFirefox =
 * "IO/Drivers/geckodriver.exe"; String DriverPathChrome =
 * "IO/Drivers/chromedriver.exe"; String ReportSnap ="Screenshots/"; String
 * Snappath = "./IO/Reports/"+Application+"/Html/Screenshots/"; String
 * HtmlReportPath = "./IO/Reports/" +Application+"/Html/"+Application
 * +" - "+FileName+".html"; String VideoPath
 * ="./IO/Reports/"+Application+"/Video/"; String CreateVideoFolder =
 * ""+Application+"/Video"; String BatchFile = "./IO/Close.bat"; String Logfile
 * = "./IO/Log4j.properties";
 * 
 ...
 * 
 * 
 * String filename = "./IO/Reports/" + File.separator +CreateVideoFolder; File f
 * = new File(filename); if (!f.exists()) { if (!f.getParentFile().exists()) {
 * f.getParentFile().mkdir(); } f.mkdir(); }
 * 
 ...
 * screenshotpath = ""+ReportSnap+Description +".png";
 * 
 ...
 * 
 * { System.setProperty("webdriver.edge.driver",DriverPathEdge); WebDriver
 ...
 * ------------------------------ // ---------------------------Maybe not
 * working after screeenshot path change ------------------------------
 * 
 * 
 * if(ObjectType.equalsIgnoreCase("Utility")) {
 ...
 * System.out.println(""+Testcases +":  " +Description +":  " +TestData
 * +":  Passed"); if (status.equalsIgnoreCase("Pass")) {
 ...
 * +Description +":  " +TestData +":  Passed"); } }
 * 
 * // --------------------------- Utility - Switch Frame Function
 * ------------------------------
 * 
 * if(ObjectType.equalsIgnoreCase("Utilitytest")) {
 ...
 * passwordField = new JPasswordField(15); JPanel pane = new JPanel(new
 ...
 * gbc.anchor = GridBagConstraints.EAST; // pane.add(userNameField, gbc); //
 * gbc.gridy = 1;
 * 
 ...
 * "Please Enter "+Description, JOptionPane.OK_CANCEL_OPTION,
 ...
 * String(passwordField.getPassword()); System.out.println(""+Testcases +":  "
 * +Description +":  " +"********" +":  Passed");
 * 
 * // String st="Please Enter MFA Code :- "; //
 * JOptionPane.showMessageDialog(null,st); // Scanner readUserInput=new
 * Scanner(System.in); //
 ...
 * 
 * public String Switchframe(WebDriver driver, String LocatorType, String
 * TestData)
 * 
 * { try { if (LocatorType.equalsIgnoreCase("PopupWindows")) {
 * 
 * System.out.println("Try to Select Frame  " +TestData); // Thread.sleep(1000);
 ...
 * 
 * } if (LocatorType.equalsIgnoreCase("MainWindows")) { Thread.sleep(1000);
 * driver.switchTo().defaultContent(); System.out.println("i am @ main window"
 * ); }
 * 
