 ...
 * 
 * 
 * public class ServiceNow { String Application = "ServiceNow Automation"; //
 * For New Application Change here required String ExcelImportFile =
 * "ServiceNow.xlsx"; // For New Application Change here required String Env
 * ="QA Environment"; // For New Application Change here required String
 * ProjectName
 * =("************************* "+Application+" ************************* ");
